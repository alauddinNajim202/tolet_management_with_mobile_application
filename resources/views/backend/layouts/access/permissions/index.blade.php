                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.permissions.create') }}" class="btn btn-warning text-white fw-semibold shadow-sm px-4 rounded-pill" style="background-color: #f97316; border-color: #f97316;"><i class="fe fe-plus me-2"></i>Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
