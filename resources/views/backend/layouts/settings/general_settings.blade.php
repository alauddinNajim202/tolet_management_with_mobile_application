                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('admin.setting.general.update') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="form-group">
                                        <label for="chatbot_question_limit" class="form-label">Chatbot Question Limit:</label>
                                        <input type="number" class="form-control @error('chatbot_question_limit') is-invalid @enderror"
                                            name="chatbot_question_limit" placeholder="Chatbot Question Limit (e.g. 50)" id="chatbot_question_limit"
                                            value="{{ $setting->chatbot_question_limit ?? old('chatbot_question_limit') ?? 50 }}">
                                        @error('chatbot_question_limit')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
